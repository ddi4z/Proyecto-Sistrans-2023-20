...
public class TipoHabitacionController {
    ...
    @GetMapping("/hotel/administrador/tiposHabitacion")
    ...
    @GetMapping("/hotel/administrador/tiposHabitacion/new")
    ...
    @PostMapping("/hotel/administrador/tiposHabitacion/new/save")
    public String TipoHabitacionGuardar(@ModelAttribute TipoHabitacion tipoHabitacion) {
        ...
        return "redirect:/hotel/administrador/servicios/tiposHabitacion";
    }

    @GetMapping("/hotel/administrador/tiposHabitacion/{id}/edit")
    public String TipoHabitacionEditarForm(@PathVariable("id") Integer id, Model model) {
        ...
        if (tipoHabitacion != null) {
            ...
            return "redirect:/hotel/administrador/tiposHabitacion";
        }
    }

    @PostMapping("/hotel/administrador/tiposHabitacion/{id}/edit/save")
    ...
    @GetMapping("/hotel/administrador/tiposHabitacion/{id}/delete")
