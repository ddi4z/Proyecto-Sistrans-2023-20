...
CREATE TABLE consumos (
    ...
    costo                  NUMBER(11, 2) NOT NULL,
    pagado                 NUMBER(1) NOT NULL,
    habitacion_id          NUMBER(6) NOT NULL,
    servicio_id            NUMBER(6),
    num_documento_cliente  VARCHAR2(10) NOT NULL,
    num_documento_empleado VARCHAR2(10) NOT NULL
);
...
ALTER TABLE fechas ADD CONSTRAINT fechas_pk PRIMARY KEY ( fecha );
...
CREATE TABLE gimnasios (
    ...
    costo_adicional NUMBER(10, 2) NOT NULL
);
...
CREATE TABLE menusestablecimientos (
    establecimientocomercio_id NUMBER(6) NOT NULL,
    producto_id                NUMBER(6) NOT NULL
);
...
CREATE TABLE menusrestaurantes (
    restaurante_id NUMBER(6) NOT NULL,
    producto_id    NUMBER(6) NOT NULL
);
...
ALTER TABLE planesconsumo
    ADD CHECK ( tipo IN ( 'LargaEstadia', 'Promocion', 'SinPlan', 'TiempoCompartido', 'TodoIncluido' ) );
...
CREATE TABLE prestamos (
    ...
    habitaciones_id NUMBER(6) NOT NULL,
...
CREATE TABLE reservas (
    ...
    plan_consumo_id NUMBER(6) NOT NULL,
    num_documento   VARCHAR2(10) NOT NULL
);
...
CREATE TABLE reservasfechas (
    fecha      DATE NOT NULL,
    reserva_id NUMBER(6) NOT NULL
);

ALTER TABLE reservasfechas ADD CONSTRAINT reservasfechas_pk PRIMARY KEY ( fecha,
                                                                          reserva_id );
...
CREATE TABLE salonesconferencia (
    ...
    costo_hora NUMBER(10, 2) NOT NULL
);
...
CREATE TABLE salonesreunion (
    ...
    capacidad     NUMBER(2) NOT NULL,
    costo_hora    NUMBER(10, 2) NOT NULL,
    costo_equipos NUMBER(10, 2) NOT NULL
);
...
ALTER TABLE servicios
    ADD CHECK ( tipo IN ( 'Bar', 'EstablecimientoComercio', 'Gimnasio', 'Internet', 'Piscina',
                          'Restaurante', 'SalonConferencia', 'SalonReunion', 'ServicioLavanderia', 'Spa' ) );
...
CREATE TABLE serviciosplanes (
    ...
    planconsumo_id NUMBER(6) NOT NULL
);
...
CREATE TABLE serviciosspareservasspa (
    reservaspa_id  NUMBER(6) NOT NULL,
    serviciospa_id NUMBER(6) NOT NULL
);
...
CREATE TABLE tienen (
    gimnasio_id        NUMBER(6) NOT NULL,
    maquinagimnasio_id NUMBER(6) NOT NULL
);
...
ALTER TABLE reservassalonconferencia
    ADD CONSTRAINT conferencia_fk FOREIGN KEY ( id_salon )
        REFERENCES salonesconferencia ( id );

ALTER TABLE reservassalonconferencia
    ADD CONSTRAINT conferencias_usuarios_fk FOREIGN KEY ( num_documento )
...
ALTER TABLE consumos
    ADD CONSTRAINT consumos_usuarios_fk FOREIGN KEY ( num_documento_cliente )
        REFERENCES usuarios ( num_documento );

ALTER TABLE consumos
    ADD CONSTRAINT consumos_usuarios_fkv2 FOREIGN KEY ( num_documento_empleado )
        REFERENCES usuarios ( num_documento );
...
ALTER TABLE prestamos
    ADD CONSTRAINT prestamos_usuarios_fk FOREIGN KEY ( num_documento )
        REFERENCES usuarios ( num_documento );
...
ALTER TABLE reservasfechas
    ADD CONSTRAINT reservasfechas_fechas_fk FOREIGN KEY ( fecha )
        REFERENCES fechas ( fecha );

ALTER TABLE reservasfechas
    ADD CONSTRAINT reservasfechas_reservas_fk FOREIGN KEY ( reserva_id )
        REFERENCES reservas ( id );

ALTER TABLE reservassalonreunion
    ADD CONSTRAINT reservasreunion_usuarios_fk FOREIGN KEY ( num_documento )
        REFERENCES usuarios ( num_documento );
...
ALTER TABLE reservasspa
    ADD CONSTRAINT reservasspa_usuarios_fk FOREIGN KEY ( num_documento )
        REFERENCES usuarios ( num_documento );
