...
insert into reservasHabitaciones values (2, 2);
insert into reservasHabitaciones values (2, 3);
insert into reservasHabitaciones values (3, 1);

--serviciosSpaReservasSpa
insert into serviciosSpaReservasSpa values (1, 1);

--reservasFechas
insert into reservasFechas values (TO_DATE('2023-10-01','YYYY-MM-DD'), 1);
insert into reservasFechas values (TO_DATE('2023-10-02','YYYY-MM-DD'), 1);
insert into reservasFechas values (TO_DATE('2023-10-03','YYYY-MM-DD'), 1);
insert into reservasFechas values (TO_DATE('2023-10-04','YYYY-MM-DD'), 1);
insert into reservasFechas values (TO_DATE('2023-10-05','YYYY-MM-DD'), 1);
insert into reservasFechas values (TO_DATE('2023-10-06','YYYY-MM-DD'), 1);
insert into reservasFechas values (TO_DATE('2023-10-07','YYYY-MM-DD'), 1);
insert into reservasFechas values (TO_DATE('2023-10-08','YYYY-MM-DD'), 1);

insert into reservasFechas values (TO_DATE('2023-10-02','YYYY-MM-DD'), 2);
insert into reservasFechas values (TO_DATE('2023-10-03','YYYY-MM-DD'), 2);
insert into reservasFechas values (TO_DATE('2023-10-04','YYYY-MM-DD'), 2);
insert into reservasFechas values (TO_DATE('2023-10-05','YYYY-MM-DD'), 2);
insert into reservasFechas values (TO_DATE('2023-10-06','YYYY-MM-DD'), 2);
insert into reservasFechas values (TO_DATE('2023-10-07','YYYY-MM-DD'), 2);
